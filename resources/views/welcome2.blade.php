...
<div class="container-fluid mt-5">
    <div class="row justify-content-center">
        <div class="col-md-8 text-light pb-5 text-center">
            <h2 class="fw-bold mb-4 text-dark">Envoi d'email Groupé</h2>
            <div class="p-4 border-2 border border-secondary rounded bg-danger " style="background-img; color: white;"> <!-- Couleur noire avec une opacité de 0.7 -->
